# Contributing to ˹Mᴀɴᴅɪʀ 𝙼𝚞𝚜𝚒𝚌˼

First of all, thank you for your interest in contributing to **MandirMusicBot**! ❤️
...
Have an idea that could improve **MandirMusicBot**?
...
```bash
git clone https://github.com/<your-username>/MandirMusicBot.git
...
Thank you for taking the time to contribute to **˹Mᴀɴᴅɪʀ 𝙼𝚞𝚜𝚒𝚌˼**.
