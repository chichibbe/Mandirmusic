...
## 📦 MandirMusic/ - Main Application Package

The core bot application containing all functionality.

### 🔧 MandirMusic/core/ - Core Components
...
### 🔌 MandirMusic/plugins/ - Command Handlers
...
### 🛠️ MandirMusic/helpers/ - Helper Functions
...
### 🌍 MandirMusic/locales/ - Message Strings
...
### 🍪 MandirMusic/cookies/ - YouTube Cookies
...
### 🚀 MandirMusic/**main**.py - Entry Point
...
### 📦 MandirMusic/**init**.py - Package Initialization

Initializes and exports core components:

```python
from MandirMusic.core import app, userbot, tune, db, yt, logger
from MandirMusic import config
```
...
```python
from MandirMusic import app, userbot, tune, db, config, logger
```

**Helper imports:**

```python
from MandirMusic.helpers import buttons, thumb, utils
from MandirMusic.helpers import is_admin, Queue, Track
```
...
- **Support Channel:** [𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐛𝐲 𝐄 ](https://t.me/Erica_movies)
- **Developer:** [𝑽𝒂𝒔𝒊𝒍𝒊𝒔𝒂 𝑴𝒂𝒏𝒅𝒊𝒓](https://t.me/Owners_E)
